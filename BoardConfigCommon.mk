...
# Recovery
TARGET_RECOVERY_FSTAB := device/mediatek/mt6580-common/recovery/etc/recovery.fstab
...
# SELinux Policy
BOARD_SEPOLICY_DIRS := \
    device/mediatek/mt6580-common/sepolicy
...
LINKER_FORCED_SHIM_LIBS := /system/lib/liblog.so|libmtkshim_log.so:/system/vendor/lib/hw/audio.primary.$(TARGET_BOARD_PLATFORM).so|libmtkshim_audio.so:/system/lib/libui.so|libmtkshim_ui.so:/system/lib/libgui.so|libmtkshim_gui.so:/system/lib/libMtkOmxVdec.so|libmtkshim_omx.so